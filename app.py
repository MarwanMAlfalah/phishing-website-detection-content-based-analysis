...
with st.expander("PROJECT DETAILS"):
    ...
    st.write('For this testing porpose project, '
    ...
    st.write('_https://github.com/MarwanMAlFalah_')
    st.write('My account on LinkedIn are available in the below link:')
    st.write('_https://www.linkedin.com/in/marwanmalfalah/_')
